  ...
  return (
		...
		>
			...
			<form onSubmit={sendEmail} className="pt-6">
				<input
					type="text"
					className=" text-slate-700 border-sky-500 focus:outline-none  bg-slate-300  placeholder:text-slate-600 rounded-none focus:border-sky-200 font-semibold placeholder:font-thin "
