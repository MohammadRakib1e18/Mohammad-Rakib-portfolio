...
const Qualification = () => {
  return (
    <div className="p-4 md:p-12 pr-4 font-serif">
      <h2 className="text-sky-500 font-bold text-2xl sm:text-4xl border-b-2 border-dotted pb-2 border-b-slate-500 flex justify-between">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
        <div className="bg-slate-600 hover:scale-105 transition ease-in-out duration-300 pl-12 p-4 border border-cyan-400 hover:border-sky-500 rounded-md text-slate-200">
      ...
      <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 gap-16">
        <div>
          <h2 className="text-sky-500 text-center font-bold text-3xl border-b-2 border-dotted pb-2 border-b-slate-500">
            Coding Skills
          </h2>
          <div className="mt-8">
